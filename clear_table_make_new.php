...
echo "<h3 style='color:red;'>🗑️ পুরনো অকেজো টেবিল ডাটা মুছে ফেলা হয়েছে...</h3>";
...
echo "<h2 style='color:green;'>✅ আলহামদুলিল্লাহ! ৫০টি নতুন অপ্টিমাইজড স্পিন তৈরি হয়েছে।</h2>";
echo "<p>এখন গেমটি রেন্ডার সার্ভারে একদম স্মুথ চলবে।</p>";
